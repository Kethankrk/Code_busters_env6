  ...
  return (
    <div className='px-4 flex flex-col items-center pb-28'>
      ...
      <div className='w-full grid grid-cols-2 gap-5 mt-5 '>
        <Link
          to='/nuetrition'
          className='col-span-1 p-3 shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] rounded-2xl flex flex-col  '
        >
      ...
      <Link
        to='/medicine'
        className='w-full flex gap-5 flex-col p-5 shadow-[rgba(50,50,93,0.25)_0px_6px_12px_-2px,_rgba(0,0,0,0.3)_0px_3px_7px_-3px] mt-5 rounded-3xl'
      >
        <div className='flex items-center gap-2'>
          {' '}
        ...
        {/* <form className='flex  shadow-[0_3px_10px_rgb(0,0,0,0.2)] px-5 py-3 rounded-full gap-1' onSubmit={e=> navigate("/medicine",{test :UserInput})}>
            <input
            required
            value={UserInput}
