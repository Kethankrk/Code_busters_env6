...
const MedicalHistory = () => {
    ...
    return (
        ...
        {testdata.reverse().map((e)=>(
             ...
             <h1 className=''><span className='font-bold'>Docter name :</span> Dr.{e.doctor}</h1>
             <h1 className=''><span className='font-bold'>Date :</span> Date</h1>
             <h1><span className='font-bold'>Description :</span> {e.description}</h1>
             <div className="flex gap-7"><h1 className='font-bold'>Medicines :</h1> 
